 ...
 * @author hi
 */
public class CreateBeauticianJPanel extends javax.swing.JPanel {

    /**
     * Creates new form CreateBeauticianJPanel
     */
     private JPanel workAreaContainer;
    private Ecosystem system;
    UserAccounts userAccounts;
    
    public CreateBeauticianJPanel(JPanel workAreaContainer, Ecosystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Beautician Name:");
    ...
    private void populateTable() {
        ...
        for (UserAccounts user : system.getUserAccountDirectory().getUserAccountDirectory()) {
            ...
            if ("Role.BeauticianRole".equals(user.getRole().getClass().getName())) {
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        if (system.getUserAccountDirectory().checkIsUnique(username) == false) {
            ...
            UserAccounts userAccounts = system.getUserAccountDirectory().createUser(adminName, username, password, null, new BeauticianRole());
            BeauticianWorker beaut = system.getBeauticianDirectory().createBeauticianWorker(adminName,username);
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        if(selectedRow < 0) {
            ...
            if(selResult == JOptionPane.YES_OPTION){
                ...
                system.getBeauticianDirectory().deleteBeauticianWorker(username);
                populateTable();
